      ...
      <ScrollView bg={"#2a2e33"} px={3} py={5}>
        ...
        <Box my={5}>
          ...
          <Text textAlign={"justify"} color={"white"} mt={3} fontSize={"16px"} lineHeight={"xl"}>
            Games Store that everything is free, We built FreeToGame to create an ecosystem that brings all the best
            Free-to-Play Games and MMO Games into one place while rewarding gamers with free premium in-game loot,
            special offers and exclusive perks. Our vision is to create the most exciting and rewarding gaming
            experience by breaking the inflexible concept of digital storefronts. You get more value... and it's all
